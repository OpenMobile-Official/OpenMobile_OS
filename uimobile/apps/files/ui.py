...
class AppIcon:
    ...
    def load_icon(self):
        try:
            ...
            # Find the .py script path in the command
            script_path = None
    ...
    def _draw_with_offset(self, mouse_pos, x_offset):
        ...
        if self.icon_img:
            ...
            # Optional fallback: Draw a colored placeholder
...
# --- Create app icons for current page ---
...
while running:
    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            delta = event.pos[0] - swipe_start_x if swipe_start_x else 0

            if abs(delta) > 30 and animation_start_time is None:
