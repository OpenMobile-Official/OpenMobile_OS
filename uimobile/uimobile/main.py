...
FOLDER_CLEAR_SCRIPT = os.path.abspath("folder_clear.py")  # new script
...
# --- Launch folder_clear.py as subprocess ---
if os.path.exists(FOLDER_CLEAR_SCRIPT):
    print("Launching folder_clear.py...")
    subprocess.Popen([sys.executable, FOLDER_CLEAR_SCRIPT])
else:
    print("⚠️ folder_clear.py not found!")
